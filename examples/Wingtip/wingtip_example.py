...
wingtip-to-wingtip connected flight of multiple drones. Run this script using:

$ python wingtip_example.py
...
if __name__=="__main__":
    ...
    # Change to the script's directory so relative paths in JSON files resolve correctly
    ...
    my_scene.display_wireframe(show_legend=True, show_vortices=True)
